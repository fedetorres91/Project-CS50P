...
# TODO 9/1
# CREATE DATABASE with user wallet, expenses history, category, description
...
db.execute("CREATE TABLE IF NOT EXISTS transactions (id INTEGER, user_id INTEGER, type TEXT NOT NULL, date DATE NOT NULL, amount FLOAT NOT NULL, PRIMARY KEY(id), FOREIGN KEY (user_id) REFERENCES users(id));")
